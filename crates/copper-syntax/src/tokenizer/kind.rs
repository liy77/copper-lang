...
pub enum TokenKind {
    ...
    Number,
    Comment,
    /// `///` (outer) or `//!` (inner) doc comment — preserved through to the
    /// generated Rust (and surfaced by the LSP), unlike a plain `//` comment.
    DocComment,
    Whitespace,
    Newline,
    For,
...
impl ToString for TokenKind {
    fn to_string(&self) -> String {
        match self {
            ...
            TokenKind::OptionalChain => "OptionalChain".to_string(),
            TokenKind::String => "String".to_string(),
            TokenKind::InterpolatedString => "InterpolatedString".to_string(),
            TokenKind::Number => "Number".to_string(),
            TokenKind::Comment => "Comment".to_string(),
            TokenKind::DocComment => "DocComment".to_string(),
